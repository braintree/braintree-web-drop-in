 ...
 *
 * @param {boolean} [options.expandOtherWaysToPay=false] When `true`, the other ways to pay menu will be expanded automatically when a customer has saved payment methods displayed.
 *

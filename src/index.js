 ...
 * @param {string} [options.paypal.buttonStyle] The style object to apply to the PayPal button. The options [found here](https://github.com/paypal/paypal-checkout/blob/master/docs/button.md#customizing-the-button) are available.
 *
 ...
 * @param {string} [options.paypalCredit.buttonStyle] The style object to apply to the PayPal Credit button. The options [found here](https://github.com/paypal/paypal-checkout/blob/master/docs/button.md#customizing-the-button) are available. The `label` property cannot be adjusted.

...
- Add support for Elo, Hiper, and Hipercardz
...
- Fix issue where a methods container for a customer with 15+ payment
...
- Fix issue where sass compilation would prevent styling of ApplePay
    button
...
- Allow card form to not be cleared after successful tokenization with
...
- Auto-prefix CSS, fixing issues in older browsers

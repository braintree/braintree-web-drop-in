...
describe('ApplePayView', () => {
  ...
  describe('initialize', () => {
    ...
    it('creates an ApplePay component', () => {
      return testContext.view.initialize().then(() => {
    ...
    it('defaults Apple Pay session to 2', () => {
      return testContext.view.initialize().then(() => {
        expect(testContext.view.applePaySessionVersion).toBe(2);
      });
    });

    it('can set Apple Pay session', () => {
    ...
    it('calls asyncDependencyFailed when Apple Pay component creation fails', () => {
    ...
    it('calls canMakePaymentsWithActiveCard with merchantIdentifier when active payment view is changed to Apple Pay', () => {
      return testContext.view.initialize().then(() => {
    ...
    it('reports error when canMakePaymentsWithActiveCard returns false in production mode',
      done => {
    ...
    it('reports developer error when canMakePaymentsWithActiveCard returns false in sandbox mode',
      done => {
    ...
    it('defaults the Apple Pay button style to black', () => {
      return testContext.view.initialize().then(() => {
    ...
    it('allows the Apple Pay button style to be customized', () => {
    ...
    describe('button click handler', () => {
      ...
      it('creates an ApplePaySession with the payment request', () => {
      ...
      it('can set which version of ApplePaySession to use', () => {
      ...
      describe('session.onvalidatemerchant', () => {
        it('performs merchant validation', () => {
        ...
        it('completes merchant validation when validation succeeds', done => {
        ...
        it('aborts session and reports an error when validation fails', done => {
      ...
      describe('session.onpaymentauthorized', () => {
        it('calls tokenize with the Apple Pay token', () => {
          const stubEvent = {
            payment: { token: 'foo' }
          };
        ...
        describe('on tokenization success', () => {
          it('completes payment on ApplePaySession with status success', done => {
          ...
          it('adds payment method to model', done => {
          ...
          it('provides shipping and billing contact in payment method when present in ApplePayPayment',
            done => {
        ...
        describe('on tokenization failure', () => {
          it('completes payment on ApplePaySession with status failure and reports the error',
            done => {
              const fakeError = new Error('fail.');
  ...
  describe('isEnabled', () => {
    ...
    it('resolves with false when Apple Pay is not enabled by merchant', () => {
    ...
    it('resolves with false when Apple Pay Session does not exist', () => {
    ...
    it('resolves with false when not https', () => {
    ...
    it('resolves with false when device cannot make payments', () => {
    ...
    it('resolves with false when device does not support the version of the apple pay session', () => {
    ...
    it('defaults ApplePaySession version to 2', () => {
    ...
    it('can set ApplePaySession version', () => {
    ...
    it('resolves with true when everything is setup for Apple Pay', () => {
      return ApplePayView.isEnabled(testContext.options).then(result => {

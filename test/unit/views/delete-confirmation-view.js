...
describe('DeleteConfirmationView', () => {
  ...
  describe('Constructor', () => {
    ...
    it('sets up a button click for the yes button', () => {
    ...
    it('sets up a button click for the no button', () => {
  ...
  describe('applyPaymentMethod', () => {
    it('applies credit card payment method delete confirmation message', () => {
      const paymentMethod = {
        nonce: 'a-nonce',
        type: 'CreditCard',
        details: {
    ...
    it('applies PayPal payment method delete confirmation message', () => {
      const paymentMethod = {
        nonce: 'a-nonce',
        type: 'PayPalAccount',
        details: {
    ...
    it('applies Venmo payment method delete confirmation message', () => {
      const paymentMethod = {
        nonce: 'a-nonce',
        type: 'VenmoAccount',
        details: {
    ...
    it('applies generic payment method message for non-card, venmo or paypal accounts', () => {
      const paymentMethod = {
        nonce: 'a-nonce',
        type: 'SomeMethod'
      };
